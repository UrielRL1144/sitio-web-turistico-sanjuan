                ...
                >
                  ...
                  <div className="absolute inset-0 bg-black/0 hover:bg-black/10 transition-all duration-300 flex items-center justify-center">
                    ...
                    >
                      ...
                      <span className="text-sm font-semibold text-gray-700">Haz clic para ampliar</span>
                    </motion.div>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:w-1/2 p-6 lg:p-8 flex flex-col overflow-y-auto max-h-[80vh] relative">
                <div className="flex-1 overflow-y-auto pr-2">
                  ...
                  <div className="bg-amber-50 rounded-2xl p-6 mb-6">
                    <h4 className="font-bold font-serif text-amber-800 text-lg mb-3">La Historia Detrás</h4>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <h4 className="font-bold font-serif text-gray-900 mb-2">Materiales Utilizados</h4>
                    ...
                    <div>
                      <h4 className="font-bold font-serif text-gray-900 mb-2">Técnicas Ancestrales</h4>
                      <div className="flex flex-wrap gap-2">
        ...
        {isImageExpanded && (
          ...
          >
            ...
            >
              ...
              <span className="font-semibold">Cerrar zoom</span>
            </motion.button>
            ...
            >
              ...
              >
                ...
                <p className="text-white/80 text-sm">Por: {craft.artisan.name}</p>
